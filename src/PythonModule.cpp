...
PYBIND11_MODULE(shasta2, shasta2Module)
{
    ...
    assemblyGraphClass
        ...
        .def("strandSymmetricCompress", &AssemblyGraph::strandSymmetricCompress)
        .def("removeZeroLengthSegments", &AssemblyGraph::removeZeroLengthSegments)
        .def("removeZeroLengthSegmentsStrandSymmetric", &AssemblyGraph::removeZeroLengthSegmentsStrandSymmetric)
       ...
       .def("detangleEdges", &AssemblyGraph::detangleEdges)
        .def("detangleAndReadFollowingSuperbubbles", &AssemblyGraph::detangleAndReadFollowingSuperbubbles)
        .def("localReadFollowing", &AssemblyGraph::localReadFollowing)
        .def("splitSelfComplementaryTangles", &AssemblyGraph::splitSelfComplementaryTangles)
        .def("separateStrands", &AssemblyGraph::separateStrands)
        ...
        .def("countIsolatedVertices", &AssemblyGraph::countIsolatedVertices)
