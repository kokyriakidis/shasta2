...
PYBIND11_MODULE(shasta2, shasta2Module)
{
    ...
    class_<AssemblyGraph>(shasta2Module, "AssemblyGraph")
        ...
        .def("countOrientedReadStepsBySegment", &AssemblyGraph::countOrientedReadStepsBySegment)
        .def("writeOrientedReadStepCountsBySegment", &AssemblyGraph::writeOrientedReadStepCountsBySegment)
